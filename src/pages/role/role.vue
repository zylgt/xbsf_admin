   ...
   <div class='collect'>
       <el-col :span='4'>
            <el-tabs tab-position="left">
                <el-tab-pane label="进行中角色"></el-tab-pane>
                <el-tab-pane label="已过期角色"></el-tab-pane>
            </el-tabs>
       </el-col>
       <el-col :span='20'>
            <div class='inner'>
                ...
                <el-table v-loading="listLoading" :data="list" header-row-class-name='headerBg' element-loading-text="正在查询中。。。"  fit highlight-current-row>
                    ...
                    <el-table-column align="center" label="数据权限" prop="author1"/>

                    <el-table-column align="center" label="菜单权限" prop="author2"/>
...
export default {
  ...
  data () {
    return {
        ...
        total:10,
        visible:false,
        list:[{id:1,name:'校长',author1:'七年级（负责人）',author2:'整体',visible:false},
              {id:2,name:'校长',author1:'七年级',author2:'整体',visible:false},
              {id:3,name:'校长',author1:'七年级',author2:'整体',visible:false},
              {id:4,name:'校长',author1:'七年级',author2:'整体',visible:false},]
    }
  },
