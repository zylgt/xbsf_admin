   ...
   <div class='collect'>
       <el-col :span='4'>
            <el-tabs tab-position="left">
                <el-tab-pane label="行政班"></el-tab-pane>
                <el-tab-pane label="教学班"></el-tab-pane>
                <el-tab-pane label="已过期行政班"></el-tab-pane>
                <el-tab-pane label="已过期教学班"></el-tab-pane>
            </el-tabs>
       </el-col>
       <el-col :span='20'>
            <div class='inner'>
                ...
                <el-table v-loading="listLoading" :data="list" header-row-class-name='headerBg' element-loading-text="正在查询中。。。"  fit highlight-current-row>
                    ...
                    <el-table-column align="center" label="关联科目" prop="object"/>
...
export default {
  ...
  data () {
    return {
        ...
        total:10,
        visible:false,
        list:[{id:1,name:'语文',object:'语文、数学',timmer:'2019-2020学年',status:1,visible:false},
              {id:2,name:'语文',object:'语文、数学',timmer:'2019-2020学年',status:2,visible:false},
              {id:3,name:'语文',object:'语文、数学',timmer:'2019-2020学年',status:2,visible:false},
              {id:4,name:'语文',object:'语文、数学',timmer:'2019-2020学年',status:1,visible:false},]
    }
  },
