   ...
   <div class='collect'>
       <el-col :span='4'>
            <el-tabs tab-position="left">
                <el-tab-pane label="进行中授权"></el-tab-pane>
                <el-tab-pane label="已过期授权"></el-tab-pane>
            </el-tabs>
       </el-col>
       <el-col :span='20'>
            <div class='inner'>
...
export default {
  ...
  data () {
    return {
        ...
        total:10,
        visible:false,
        list:[{id:1,name:'张三',number:'100012',card:'老师',roles:'校长',visible:false},
              {id:2,name:'张三',number:'100012',card:'学生',roles:'校长',visible:false},
              {id:3,name:'张三',number:'100012',card:'校长',roles:'校长',visible:false},
              {id:4,name:'张三',number:'100012',card:'校长',roles:'校长',visible:false},]
    }
  },
