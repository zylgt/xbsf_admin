       ...
       <el-col :span='20'>
            <div class='inner'>
                ...
                <el-table v-loading="listLoading" :data="list" header-row-class-name='headerBg' element-loading-text="正在查询中。。。"  fit highlight-current-row>
                    ...
                    <el-table-column align="center" label="评比名称" prop="name"/>

                    <el-table-column align="center" label="内容" prop="inner"/>

                    <el-table-column align="center" label="基础分值">
                        <template slot-scope="scope">
                            {{scope.row.base}}分
                        </template>
                    </el-table-column>
                     <el-table-column align="center" label="总均分">
                        <template slot-scope="scope">
                            {{scope.row.all}}分
                        </template>
                    </el-table-column>
...
export default {
  ...
  data () {
    return {
        ...
        total:10,
        visible:false,
        list:[{id:1,name:'荣誉获奖数据采集任务',inner:'6项',base:'30',all:'80',visible:false},
              {id:2,name:'荣誉获奖数据采集任务',inner:'6项',base:'30',all:'80',visible:false},
              {id:3,name:'荣誉获奖数据采集任务',inner:'6项',base:'30',all:'80',visible:false},
              {id:4,name:'荣誉获奖数据采集任务',inner:'6项',base:'30',all:'80',visible:false},]
    }
  },
