<template>
   <div class='newCollect'>
       <el-page-header @back="goBack" content="新建采集"></el-page-header>
       <div class='nav'>
           <div :class="['nav_list',nav_active==1?'active':'']" @click="navTab(1)" >填报采集</div>
           <el-divider direction="vertical"></el-divider>
           <div :class="['nav_list',nav_active==2?'active':'']"  @click="navTab(2)">导入采集</div>
       </div>
       <el-form ref="ruleForm" :model="ruleForm" label-width="160px">
            ...
            <el-form-item label="采集对象">
                ...
                <el-tag effect="dark" @click="dialogTableVisible=true,dialogTitle='采集对象'" > 添加 <i class='el-icon-plus'></i> </el-tag>
            </el-form-item>
            <el-form-item label="评审老师">
                ...
                <el-tag effect="dark" @click="dialogTableVisible=true,dialogTitle='评审老师'"> 添加 <i class='el-icon-plus'></i> </el-tag>
            </el-form-item>
            <el-form-item label="基础型指标（共3项）">
                <el-checkbox-group v-model="ruleForm.type">
                    <el-checkbox label="性别(单选,自动)" name="sex"></el-checkbox>
                    <el-checkbox label="民族(单选,自动)" name="nation"></el-checkbox>
                    <el-checkbox label="身份证(单选,自动)" name="card"></el-checkbox>
                    <el-checkbox label="政治面貌(单选,自动)" name="politics"></el-checkbox>
                    <el-checkbox label="籍贯(单选,自动)" name="birth"></el-checkbox>
                    <el-checkbox label="类别(单选,自动)" name="type"></el-checkbox>
                </el-checkbox-group>
            </el-form-item>
            ...
            <el-form-item label="动态型指标（共3项）">
             ...
             <el-form-item v-if='nav_active==2' >
                <el-button type="success" size='medium' plain>模板下载</el-button>
                <el-button type="warning" size='medium' plain>数据导入</el-button>
            </el-form-item>
            <el-form-item>
...
.newCollect .el-form-item__content{
    display: flex;
